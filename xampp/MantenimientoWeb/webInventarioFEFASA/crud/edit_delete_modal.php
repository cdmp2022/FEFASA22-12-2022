<!-- Editar -->
<div class="modal fade" id="edit_<?php echo $row['identidad']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<form method="POST" action="../crud/usuarios/edit.php?id=<?php echo $row['identidad']; ?>">
				...
				<div class="row form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="centro" value="<?php echo $row['centro']; ?>">
					</div>
				</div>
				<div class="row form-group">
					<div class="col-sm-2">
				...
				<div class="row form-group">
					<div class="col-sm-2">
						<label class="control-label" style="position:relative; top:7px;">Sub Area:</label>
					</div>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="subArea" value="<?php echo $row['subArea']; ?>">
					</div>
				</div>
            </div> 
			</div>
...
<!-- Eliminar -->
<div class="modal fade" id="delete_<?php echo $row['identidad']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"><span class="fa fa-close"></span> Cancelar</button>
                <a href="../crud/usuarios/delete.php?id=<?php echo $row['identidad']; ?>" class="btn btn-danger"><span class="fa fa-trash"></span> Si</a>
            </div>
